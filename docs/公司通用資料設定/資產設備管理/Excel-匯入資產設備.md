...
![圖四 - 填寫資產設備模板](../../images/ec54bbc261d7875e.png)
{% endstep %}
...
![圖五 - 選取資產分類](../../images/7ceacf8f1094ce64.png)
...
![圖六 - 選擇檔案](../../images/f0df0bd11f5bd93a.png)

如圖七 \~ 圖八所示，檔案上傳成功並確認內容無誤後，即可點&#x9078;**「儲存」**&#x5B8C;成匯入作業。

<div>![圖七 - 上傳檔案 (一)](../../images/7547a2c3715878c5.png) ![圖八 - 上傳檔案 (二)](../../images/81a0229c5b0e16d0.png)</div>
{% endstep %}
...
!!! warning
    ...
    有關手動編輯之詳細操作流程，請參閱 ➙ [#id-04-1-bian-ji-zi-chan-she-bei](../../../dcp/company-configuration/asset-management#id-04-1-bian-ji-zi-chan-she-bei "mention")


![圖九 - 完成畫面/其他資訊說明](../../images/3932d01aca3950c7.png)
{% endstep %}
{% endstepper %}
