...
<div>![進入專案後，點選「點工」](../../images/92b8a7df2a940a61.png) ![點選「+新增派遣商」](../../images/6064512b8b3ceacd.png)</div>

<div>![輸入派遣商的專案驗證碼](../../images/6d781c802957e6ac.png) ![分享專案驗證碼給派遣商](../../images/2c8806b489b476bb.png)</div>
{% endstep %}
...
<div>![(App)進入專案內部，點選「點工」功能](../../images/c11b07c26af8fa53.png) ![點選「新增點工單」](../../images/9d8fd649a454b389.png) ![填寫點工需求資料](../../images/6fb37cdf5d914ebe.png)</div>
{% endstep %}
...
<div>![點選「簽到/簽退」](../../images/70fcbfb6244a3392.png) ![掃描QR code](../../images/0776ed6a9cdb7ab0.png)</div>
{% endstep %}
{% endstepper %}
