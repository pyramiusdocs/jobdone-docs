...
### 下載並匯入 Excel 模板 <a href="#xia-zai-bing-hui-ru-excel-mu-ban" id="xia-zai-bing-hui-ru-excel-mu-ban"></a>

點選下載 「 工種 ( 工別 ) Excel 模版 」，使用模板填妥資料，上傳檔案後點選 「 匯入 」 即可批次匯入工種 ( 工別 ) 類型資料。

![](images/fd36c8aab739fc77.png)
